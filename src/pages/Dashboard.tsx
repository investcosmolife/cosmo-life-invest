          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-3">
              <div className="text-center p-4 bg-white rounded-lg border">
                ...
                <div className="text-xs text-blue-600 font-bold">$5,000,000</div>
              </div>
              <div className="text-center p-4 bg-white rounded-lg border">
                <div className="text-2xl mb-2">🚗</div>
                <div className="text-sm font-medium mb-1">Заказ такси</div>
                <div className="text-xs text-blue-600 font-bold">$3,000,000</div>
              </div>
              <div className="text-center p-4 bg-white rounded-lg border">
                <div className="text-2xl mb-2">🍔</div>
                <div className="text-sm font-medium mb-1">Доставка еды</div>
                <div className="text-xs text-blue-600 font-bold">$2,500,000</div>
              </div>
              <div className="text-center p-4 bg-white rounded-lg border">
                <div className="text-2xl mb-2">🏠</div>
